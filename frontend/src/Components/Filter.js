...
import {  Chip,
    ...
    RadioGroup,
    Slider,
    TextField,Tooltip,Typography,Pagination,Autocomplete,
...
// import { listTalentPool } from "../company/api-company";
...
export default function TalentPools(props) {
 ...
 // console.log("filtered skills",filter);
  ...
  //   try {
  //     console.log("Data to query: ",filter);
  //    let result = await listTalentPool({ t: jwt.token },filter);
  //     if (!result.error) {
  //       console.log('My Talents ',result);
  //       setTalents(result)
  //     }
  //   } catch (error) {
  //     console.log(error);
        ...
        <Grid container spacing={0}>
          <Grid item md={3} xs={12} >
            ...
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}> 
              ...
              {/* <Button style={{color:'red'}} onClick={fetchData}><Typography> Search Talent </Typography></Button> */}
              </div>
              <div>
          ...
          <Grid item md={8} xs={12} >
            ...
            <Grid  spacing={0} style={{ paddingLeft: "20px" }}>
                <Talent/>
